const menu = [
  ...
  const menuContainer = document.querySelector('.main-container__menus');
  ...
  function displayAllItems(menu){
      let display = menu.map(menuItem => {
          return `<div class="menu">
          <img class="image" src=${menuItem.img}>
          <div class="info">
              <div class="title">
  ...
  function displayButtons() {
      ...
      filterBtns.innerHTML = buttons
      let Buttons = filterBtns.querySelectorAll('.filter-btn')
     Buttons.forEach((button) => {
          ...
          if(category === "all") displayAllItems(menu)
          else displayAllItems(menuCategory)
      })
  })
